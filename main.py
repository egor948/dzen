...
1.  **Найди 3-6 (НЕ БОЛЬШЕ 6!)** КАЧЕСТВЕННЫХ, АГРЕГИРОВАННЫХ сюжетов для статей. 
    **Ключевое требование:** Объединяй все смежные или похожие новости в один крупный сюжет.
    
    Для каждого сюжета верни JSON-объект с полями: `title`, `category` и **строгий список `search_queries` из 3 элементов**:
