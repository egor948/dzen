 ...
 **Найди 3-6 (НЕ БОЛЬШЕ 6!)** КАЧЕСТВЕННЫХ, АГРЕГИРОВАННЫХ сюжетов для статей. 
    ...
    *   **Первый запрос (СТРОГИЙ):** Максимально точный, контекстуальный и уникальный. (Пример: "Hansi Flick Barcelona training").
    *   **Второй запрос (УМЕРЕННЫЙ):** Чуть более общий, но все еще релевантный. (Пример: "Hansi Flick Barcelona").
    *   **Третий запрос (ОБЩИЙ, Резервный):** Только имя персоны или название клуба, чтобы гарантировать результат. (Пример: "Hansi Flick" или "Barcelona").
